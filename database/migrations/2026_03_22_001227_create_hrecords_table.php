...
return new class extends Migration
{
    ...
    {
        Schema::create('hrecords', function (Blueprint $table) {
            $table->id();
            $table->string('hname')->nullable();
            $table->string('hoslevel')->nullable();
            $table->string('location')->nullable();
            $table->string('hregno')->nullable();
            $table->string('hos_services')->nullable();
